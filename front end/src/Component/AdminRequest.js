    ...
    return (
      ...
      <div>
        ...
        >
          <div className="me-5">
            <Link
              to={"/admin/enquiryMadeByCustomer"}
              ...
              >
                <Card.Body>
                  ...
                  <div className="text-center pt-3">
                    <h5><b>View All Request</b></h5></div>
            ...
            >
              ...
              >
                <Card.Body>
                  ...
                  <div className="text-center pt-3">
                    <h5><b>Approve Request</b></h5>
                  </div>
                </Card.Body>
              </Card>
            </Link>
          </div>
          <div className="me-5yy">
            <Link
              to={"/admin/servicecost"}
              style={{ textDecoration: "none", color: "black" }}
            >
              <Card
                style={{
