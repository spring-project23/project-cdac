...
import { FaRupeeSign, FaUserFriends, FaUsersCog, FaDropbox, FaComments } from "react-icons/fa";
...
class AdminDashboard extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      totalCustomerCount: 0, totalMechanicCount: 0, totalRequestCount: 0, totalFeedbackCount: 0
    };
  }
  ...
  componentDidMount() {
    ...
    RequestService.getAllRequests()
      .then((res) => {
        ...
        this.setState({ totalRequestCount: res.data.length, totalFeedbackCount: fcnt })
      });
    ...
    return (
      <div style={{
        ...
        <div
          ...
          style={{ display: "flex", flexdirection: "row", margin: '35px' }}
        >
          <div className="me-5">
            <Link
              to={"#"}
