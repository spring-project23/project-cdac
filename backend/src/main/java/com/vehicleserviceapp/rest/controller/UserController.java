...
//
//@PostMapping("/login")
//public  ResponseEntity<?> getUserByEmailIdAndPassword(@RequestBody LoginModel loginModel) {
//	System.out.println(loginModel);
//	ResponseEntity<User> user=userService.getOneUser(loginModel.getEmail(),loginModel.getPassword());
//	if(user==null)
